...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 z-[1000] w-full">
      <nav aria-label="Global" className="flex container items-center justify-between py-5">
        <div className="flex lg:flex-1">
          <Link href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Your Company</span>
            <Image
              alt=""
              src="/assets/img/brand-logo/falconvertex-brand-logo.png"
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-6">
          ...
          <Link href="/about-us" className="text-sm/6 text-gray-900">
            About Us
          </Link>
              ...
              <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                {callsToAction.map((item) => (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 text-gray-900 hover:bg-gray-100"
                  >
          ...
          <Link href="blog" className="text-sm/6 text-gray-900">
            Blogs
          </Link>
          <Link href="contact-us" className="text-sm/6 text-gray-900">
            Contact Us
          </Link>
        </PopoverGroup>
